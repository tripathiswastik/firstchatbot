...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 12:01:37 2019

@author: aviral,swastik,bharat,priyanshu
"""
...
model=Sequential()
model.add(Dense(99,input_dim=x_train.shape[1],activation='sigmoid'))
model.add(Dense(180,input_dim=199,activation='sigmoid'))
